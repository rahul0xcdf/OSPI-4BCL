...
const App = () => {
  ...
  return (
    <div>
      ...
      setSQ3 = {setSQ3} setAns1 = {setAns1}  setAns2 = {setAns2} setAns3 = {setAns3} setphoneNo = {setphoneNo} ctrF = {ctrF} setCtrF = {setCtrF}/>}
      ...
      {(tfa !== true && ctrT < 3) && <PhoneNumVer setTfa={setTfa} setDbd = {setDbd} phone_no = {phone_no} ctrT = {ctrT} setCtrT = {setCtrT}/>}
